...
- _USE_SDL - сборка осуществляется вместе с библиотекой sdl;
- _HAVE_ICONV - сборка с библиотекой iconv (только для совместимости с играми на URQL);
...
- _WIN32_WCE - сборка для WCE;
- __APPLE__ - сборка для OS X;
- IOS - сборка для IOS;
