...
r2 = dlg {
	...
	phr = {
		...
		{ tag = 'оружие',
			...
			[[ if not here():empty 'лестница' then p '^— Дальше.'; pret()  end]]
		},
		{
			"Benelli M4...",
			[[— Benelli M4 Super 90, шестизарядный, с телескопическим прикладом, пистолетной рукояткой, планкой Пикатинни...]],
			[[ if not here():empty 'лестница' then p '^— Всё, заткнись, давай дальше.'; pret()  end]]
		},
		{},
		...
		{  "Управляющий.", 
			...
			— Хмм, ну ладно, допустим, я с ним разберусь, что ещё?]],
		},
		{  "Собаки.", 
			[[— Собаки.^
			— Собаки?^
			...
			— Много?^
			— Четыре.^
			— Ох... Ну допустим, с собаками я как-нибудь управлюсь. Что-то ещё?.]]
		},
...
--[[
*1 — Что?
*2 — Но я здесь не работаю...
*3 — Хранилище в подвале.
...
— Занятно. Тогда почему на твоём бейдже написано «Старший кассир»?
*211 — Я его одолжил, чтобы через турникет пройти.
*3 — Хранилище в подвале...
...
[когда все варианты исчерпаны] — А другой путь есть?
[если не было]*32 — На лифте...
[иначе]*4 — Нет...
...
— 124 килограмма. А вы сколько весите?
— 61. Мда. Тут даже клонирующая машина бы не помогла. Ладно, дальше.
[когда все варианты исчерпаны] *32331 — По системам всё
...
И с этими словами он выбегает из отделения банка, где его ловит экипаж инкассаторской машины, приехавшей, чтобы как раз перевезти содержимое хранилища в другой район города. Хе-хе.
]]
end